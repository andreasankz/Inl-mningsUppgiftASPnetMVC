...
namespace InlämningsUppgiftASPnetMVC
{
    public class Startup
    {
        ...
        {
            services.AddDbContext<SchoolPortalDbContext>(options => options.UseSqlServer(Configuration.GetConnectionString("MainConnection")));
