...
namespace InlämningsUppgiftASPnetMVC.Controllers
{
    ...
    public class ClassesController : Controller
    {
        ...
        public ClassesController(SchoolPortalDbContext context, UserManager<ApplicationUser> userManager)
        {
            _context = context;
        ...
        public async Task<IActionResult> Index()
        {
            ...
            {
                schoolClass.Teacher = await _userManager.Users.FirstOrDefaultAsync(app => app.Id == schoolClass.TeacherId);
            }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(Guid id, [Bind("Id,ClassName,TeacherId,Created,SchoolClassStudents")] SchoolClass schoolClass)
        {
